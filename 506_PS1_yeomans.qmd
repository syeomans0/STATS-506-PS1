...
d.  Which weight has the highest correlation with rings?
...
male_cor <- cor(males$Shell_weight, males$Rings)
print(male_cor)
female_cor <- cor(females$Shell_weight, females$Rings)
print(female_cor)
infant_cor <- cor(infants$Shell_weight, infants$Rings)
print(infant_cor)
