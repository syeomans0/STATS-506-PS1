...
for (i in 100:500) {
  ...
  else if (seq_length == shortest_seq_length) {
  ...
  } else if (seq_length == longest_seq_length) {
...
```
ChatGPT told me to use `cat()` when I gave it my code when my print statements weren't working properly. I used this website to check if my outputs made sense <https://www.dcode.fr/collatz-conjecture>, which they did. 
